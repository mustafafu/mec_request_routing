...
echo "include './iter_runs/semi_mip_${iter}.run';exit;" | ../../../ampl_linux-intel64/ampl > ../Output/greedy_output_${iter}_0.txt

echo "First LP finished"
#cat ../Output/greedy_output_${iter}_0.txt
...
do
	...
	echo "${iteration}"
	echo $flag
	echo "include './iter_runs/semi_mip_${iter}.run';exit;" | ../../../ampl_linux-intel64/ampl > ../Output/greedy_output_${iter}_${iteration}.txt
