...
## Variables
var server_indicator {Nodes,Users} >= 0 binary;  # Placing a function on node N for user U
var access_indicator {Nodes,Users} >= 0 binary; #1 if user u can access to network through node n.
