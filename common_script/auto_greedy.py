...
# iter=sys.argv[1],zero_constraint=sys.argv[2],threshold=sys.argv[3]
...
if __name__ == '__main__':
    ...
    flag = get_max_from_lp(filename='./Output/greedy_output.txt',modepath='./semi_mip.mod',iter=sys.argv[1],zero_constraint=sys.argv[2],threshold=sys.argv[3])
